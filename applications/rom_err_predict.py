...
def main(argv):
    ...
    regressor.train(input_fn=finInstance.train_input_fn,
                            steps=train_steps, hooks=[logging_hook])

    eval_result = regressor.evaluate(input_fn=finInstanc.eval_input_fn, steps=eval_steps)
    print(eval_result)
...
if __name__ == "__main__":
    ...
    tf.flags.DEFINE_integer('train_steps', 100, 'Number of training steps to take.')
